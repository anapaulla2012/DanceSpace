...
<section class="py-5 text-center container" style= "background-image: url('img/fundo.png'); background-repeat:no-repeat;align=center">
      ...
      <div class="col-lg-6 col-md-8 mx-auto">
        <p>
        <h1 class="fw-light" style= "align=center">DanceSpace</h1>
      ...
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
        <div class="col">
          <div class="card shadow-sm">
            <svg class="bd-placeholder-img card-img-top" width="100%" height="225" img="img/Salao.png" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#55595c"/><text x="50%" y="50%" fill="#eceeef" dy=".3em">Thumbnail</text></svg>
